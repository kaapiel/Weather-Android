...
import br.com.aguido.weather.service.WeatherManager;
import br.com.aguido.weather.ui.home.HomeActivity;
import br.com.aguido.weather.ui.login.LoginActivity;
    ...
    private void validateWifiNetwork() {
        ...
        if(!new WeatherManager(this).isEmulator()){
            ...
            if (WifiInfo.getDetailedStateOf(wifiInfo.getSupplicantState()) == NetworkInfo.DetailedState.CONNECTED ||
                ...
                if(wifiInfo.getSSID().contains(Constants.Wifi.SIGMA) || wifiInfo.getSSID().contains(Constants.Wifi.CORP)){
                    new MongoDB().execute();
                } else {
                    exitApp();
                }
